...
htmlhelp_basename = 'z_laser_msgs_doc'
...
latex_documents = [
    (master_doc, 'z_laser_msgs_doc.tex', u'z_laser_msgs Documentation',
...
man_pages = [
    (master_doc, 'z_laser_msgs_doc', u'z_laser_msgs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'z_laser_msgs', u'z_laser_msgs Documentation',
     author, 'z_laser_msgs', 'One line description of project.',
     'Miscellaneous'),
]
