[//]: <> (<img src="ZLASER.png" width="142" height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="FADA.png" width="170" height="50">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="CATEC.png" width="138" height="50">)
...
There are 2 sources to install z_laser_projector from:
...
This will install both z_laser_projector and its dependents, including zlp library and Z-LASER SDK.

* ### Method 2: Install z_laser_projector from Sources

If z_laser_projector package is not installed ...
```
...
import zlaser_sdk_ros.projector_manager
```

* ### Method 3: Install z_laser_projector from Sources
   ...
   - Clone the latest z_laser_projector ROS package from [here](https://github.com/.../releases) into 'catkin_ws/src/'
        ```bashrc
        cd ~/catkin_ws/src/
        git clone https://....git
        ```
...
To launch the ros node included in this package to connect to projector:
...
If z_laser_projector package is installed and compiled you can use libraries in another package
```
#!/usr/bin/env python3
