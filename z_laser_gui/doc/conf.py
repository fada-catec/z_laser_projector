...
sys.path.insert(0, os.path.abspath('../src/z_laser_gui'))
...
htmlhelp_basename = 'z_laser_gui_doc'


# -- Options for LaTeX output ------------------------------------------------
latex_elements = {}
latex_documents = [
    (master_doc, 'z_laser_gui_doc.tex', u'z_laser_gui Documentation',
     u'Rafael Luque', 'manual'),
]

# -- Options for manual page output ------------------------------------------
man_pages = [
    (master_doc, 'z_laser_gui_doc', u'z_laser_gui Documentation',
     [author], 1)
]

# -- Options for Texinfo output ----------------------------------------------
texinfo_documents = [
    (master_doc, 'z_laser_gui', u'z_laser_gui Documentation',
     author, 'z_laser_gui', 'One line description of project.',
     'Miscellaneous'),
]
